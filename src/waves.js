export const waves = () => {
  ...
  const waves = new ShaderProgram(document.querySelector(".waves"), {
    ...
    onResize(w, h, dpi) {
      ...
      // Convert hex color #9200ee to RGB values (0-1 range)
      const r = 0x92 / 255; // 146/255 ≈ 0.573
      const g = 0x00 / 255; // 0
      const b = 0xee / 255; // 238/255 ≈ 0.933
      ...
      for (let x = 0; x < width; x += distance) {
        for (let z = 0; z < depth; z += distance) {
          ...
          color.push(
            ...
            g,
            b,
            z / depth  // Keeping the alpha gradient for depth effect
          );
        }
      }
