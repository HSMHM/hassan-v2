...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFY_EMAIL', 'hassan@almalki.sa'),
    ...
    'monitor_backups' => [
        [
            ...
            'disks' => ['local'],
            'health_checks' => [
                // Monthly backup → allow up to 32 days between runs
                MaximumAgeInDays::class => 32,
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
            // Monthly cadence: keep last 12 months
